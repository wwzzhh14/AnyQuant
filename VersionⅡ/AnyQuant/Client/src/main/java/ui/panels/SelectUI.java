...
import ui.GetLocation;
import ui.MarketFrame;
import ui.StockFrame;
import ui.myui.EmptyTextField;
import ui.myui.MyButton;
import ui.myui.MyCheckBox;
        ...
        private void init(){
            ...
            Search.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent arg0) {
                    ...
                    if (box_open.isSelected()&&(!textField_open_s.equals(""))&&(!textField_close_e.equals(""))){
                    ...
                    if (box_high.isSelected()&&(!textField_high_s.equals(""))&&(!textField_high_e.equals(""))){
                    ...
                    if (box_low.isSelected()&&(!textField_low_s.equals(""))&&(!textField_low_e.equals(""))){
                    ...
                    if (box_close.isSelected()&&(!textField_close_s.equals(""))&&(!textField_close_e.equals(""))){
                    ...
                    if (box_volume.isSelected()&&(!textField_volume_s.equals(""))&&(!textField_volume_e.equals(""))){
                    ...
                    if(type==0) {
                        ...
                        StockFrame.button_deep.doClick();
                    }else{
                        MarketFrame.button_deep.doClick();
                    }
                    close();
