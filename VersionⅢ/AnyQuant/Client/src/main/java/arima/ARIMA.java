...
//          System.out.println("AIC of these model=" + "model is [p,q]=" + "[" + model[0] + " " + model[1] + "]"+temp);

//            System.out.println("AIC of these model=" +df3.format(temp));
            if (temp < minAIC) {
                bestModelindex = i;
                minAIC = temp;
...
//        System.out.print(bestModelindex+" ");
//        System.out.print(df3.format(minAIC)+" ");
//        System.out.println("AIC of these model=" + "model is [p,q]=" + "[" + model[bestModelindex][0] + " " + model[bestModelindex][1] + "]");
