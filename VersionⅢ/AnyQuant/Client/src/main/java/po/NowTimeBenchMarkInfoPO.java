 ...
 */
public class NowTimeBenchMarkInfoPO {
    ...
    public NowTimeBenchMarkInfoPO(double dealNum, double dealPri, double highPri, double increPer, double increase,
