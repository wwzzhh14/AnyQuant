...
public class ScatterPlotDemo extends ApplicationFrame {
    ...
    public ScatterPlotDemo(String title) {
        ...
        JPanel chartPanel = new businesslogic.visualizationlogic.VisualizationStockPanelimpl().getCompareStockPanel("sh600000",true,Color.BLUE);
...
//        chartPanel.setPreferredSize(new java.awt.Dimension(1024, 600));
    ...
    private static JFreeChart createChart(XYDataset dataset) {
        JFreeChart chart = ChartFactory.createScatterPlot("Scatter Plot MyDemo 1",
